...
**
** Created: Sat Jul 19 11:20:19 2008
...
static const char qt_meta_stringdata_personel[] = {
    "personel\0"
};

const QMetaObject personel::staticMetaObject = {
    { &libdbBase::staticMetaObject, qt_meta_stringdata_personel,
      qt_meta_data_personel, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_personel))
	return static_cast<void*>(const_cast< personel*>(this));
